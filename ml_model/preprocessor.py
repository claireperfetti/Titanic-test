...
class GetDummies(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        X_local = pd.get_dummies(X_local, columns=dummies_list, prefix=dummies_prefix, drop_first=True)
        all_cols = ['Pclass', 'SibSp', 'Parch', 'FamilySize', 'Sex_male', 'Title_Miss',
        ...
        print(X_local.columns)
        print(len(X_local.columns))
        return X_local
